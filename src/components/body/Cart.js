                ...
                return(
                        <tbody key={index}>
                            <tr>
                                ...
                                <td>
                                <button id="minus" className="btn1" onClick={MinusHandle} value={item.id}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" fill="currentColor" class="bi bi-dash" viewBox="0 0 16 16">
                                ...
                                &nbsp;
                                &nbsp;
                                <button id="plus" className="btn2" onClick={PlusHandle} value={item.id}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
